...
class QueryBuilderTest {
    ...
    void buildQueries_oneDependency_shouldReturnOneQuery() {
        ...
        assertEquals("g:org.apache.commons+AND+a:commons-lang3", result.getFirst());
    }
    ...
    void buildQueries_onePlugin_shouldReturnOneQuery() {
        ...
        assertEquals(1, result.size());
        assertEquals("g:org.apache.maven.plugins+AND+a:maven-compiler-plugin", result.getFirst());
    }
